...
export const messages: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    domainTagRulesTitle: '网站自动 tags（即将上线）',
    domainTagRulesHint: '后续版本将支持根据访问网站自动添加 tags，当前请先使用 popup 标签栏手动选择。',
  ...
  'en': {
    ...
    domainTagRulesTitle: 'Website auto-tags (coming soon)',
    domainTagRulesHint: 'A future version will support auto-adding tags based on the website. For now, use the popup tag bar.',
